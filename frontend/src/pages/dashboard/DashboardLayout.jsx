...
import { useGetNotificationsQuery } from '../../redux/features/orders/ordersApi';
          ...
          <div className="flex flex-shrink-0 items-center ml-auto">
            <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
              ...
              <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
                <span className="font-semibold">Umme Hani</span>
                <span className="text-sm text-gray-600">Administrator</span>
              </div>
              <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLOnTUQDEWGElcbhNOmFzp7FN3RN3uX1AcUA&s" alt="user profile photo" className="h-full w-full object-cover"/>
              </span>
...
// Notification dropdown button component
function NotificationButton({ notifications, isLoading }) {
        ...
        <div className="absolute right-0 mt-2 w-64 bg-white shadow-lg rounded-lg z-50">
          {isLoading ? (
            ...
            notifications.map((n, i) => (
              <div key={i} className={`p-4 border-b ${n.isRead ? 'bg-gray-50' : 'bg-purple-50 font-semibold'}`}>
